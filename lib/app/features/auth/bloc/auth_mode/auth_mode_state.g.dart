...
abstract class AuthModeState extends Equatable {
  ...
  factory AuthModeState.signinMode({@required String signingUsername}) = SigninMode;
...
class SigninMode extends AuthModeState {
  const SigninMode({@required this.signingUsername}) : super(_AuthModeState.SigninMode);

  final String signingUsername;

  @override
  String toString() => 'SigninMode(signingUsername:${this.signingUsername})';
  @override
  List get props => [signingUsername];
}
