...
class AgendaStyle {
  AgendaStyle(
      {this.appointmentTextStyle, this.dayTextStyle, this.dateTextStyle, this.backgroundColor = Colors.transparent});
...
class MonthCellStyle {
  MonthCellStyle({
    ...
    this.leadingDatesTextStyle,
            ...
            const TextStyle(fontSize: 13, fontFamily: 'Roboto', color: Color.fromARGB(255, 255, 255, 255));
