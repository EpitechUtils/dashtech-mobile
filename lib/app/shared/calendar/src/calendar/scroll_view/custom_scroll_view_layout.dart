...
class _CustomScrollViewerLayout extends MultiChildRenderObjectWidget {
  _CustomScrollViewerLayout(List<Widget> children, this._calendar, this._position, this._currentChildIndex)
  ...
  void updateRenderObject(BuildContext context, RenderObject renderObject) {
    ...
    if (panel._calendar.monthViewSettings.navigationDirection != _calendar.monthViewSettings.navigationDirection ||
...
class _CustomScrollViewLayout extends RenderWrap {
  _CustomScrollViewLayout(this._calendar, this._position, this._currentChildIndex);
  ...
  @override
  void performLayout() {
    double currentChildXPos, firstChildXPos = 0, lastChildXPos, currentChildYPos, firstChildYPos = 0, lastChildYPos;
    ...
    if (_calendar.monthViewSettings.navigationDirection == MonthNavigationDirection.horizontal ||
      ...
      lastChildYPos = 0;
        ...
        _calendar.monthViewSettings.navigationDirection == MonthNavigationDirection.vertical) {
      height = height / 3;
      firstChildYPos = 0;
      currentChildXPos = 0;
      lastChildXPos = 0;
