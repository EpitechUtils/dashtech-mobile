...
import 'app/features/notification/business/use_cases/find_notifications_usecase.dart';
import 'app/features/profile/business/use_cases/find_profile_autolog_usecase.dart';
...
import 'app/features/planning/business/use_cases/find_week_activities_usecase.dart';
...
import 'app/features/notification/bloc/notifications_bloc.dart';
import 'app/features/notification/business/data_sources/notifications_data_source.dart';
import 'app/features/planning/bloc/planning_bloc.dart';
import 'app/features/planning/business/data_sources/planning_data_source.dart';
...
GetIt $initGetIt(
  ...
  gh.factory<NotificationsDataSource>(
      () => NotificationsDataSource(client: get<GraphQLClient>()));
  gh.factory<PlanningDataSource>(
      () => PlanningDataSource(client: get<GraphQLClient>()));
  ...
  gh.factory<FindNotificationsUseCase>(
      () => FindNotificationsUseCase(get<NotificationsDataSource>()));
  gh.factory<FindProfileAutologUseCase>(
      () => FindProfileAutologUseCase(get<ProfileDataSource>()));
  ...
  gh.factory<FindWeekActivitiesUseCase>(
      () => FindWeekActivitiesUseCase(get<PlanningDataSource>()));
  ...
  gh.factory<NotificationsBloc>(() => NotificationsBloc(
      findNotificationsUseCase: get<FindNotificationsUseCase>(),
      findProfileAutologUseCase: get<FindProfileAutologUseCase>()));
  gh.factory<PlanningBloc>(() => PlanningBloc(
