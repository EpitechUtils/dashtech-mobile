...
GetIt $initGetIt(
  ...
  gh.factory<NotificationsDataSource>(() => NotificationsDataSource(client: get<GraphQLClient>()));
  ...
  gh.factory<FindNotificationsUseCase>(() => FindNotificationsUseCase(get<NotificationsDataSource>()));
  gh.factory<FindProfileAutologUseCase>(() => FindProfileAutologUseCase(get<ProfileDataSource>()));
